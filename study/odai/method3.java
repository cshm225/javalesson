...
public class method3{
	public static void main(String[] args){
		...
		print(scores);
		System.out.println("国語の点数が高い順にならびかえます");
		Sort2DArrayDescending(scores,2);
		print(scores);
		System.out.println("数学の点数が高い順にならびかえます");
		Sort2DArrayDescending(scores,3);
		print(scores);
		System.out.println("英語の点数が高い順にならびかえます");
		Sort2DArrayDescending(scores,4);
		print(scores);
		System.out.println("合計の点数が高い順にならびかえます");
		Sort2DArrayDescending(scores,5);
		print(scores);
		System.out.println("ソート前を表示します");
